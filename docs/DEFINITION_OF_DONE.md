...
- [x] Persistent controlled sessions.
...
NIRA remains a flagship candidate until a real local model profile, memory lifecycle controls, retrieval evaluation, safe revise/retry UX, and manual accessibility evidence pass.
